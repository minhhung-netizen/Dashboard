...
const translations = {
  en: {
    ...
    confirmAll: "All trend states",
    confirmedOnly: "Strong trend",
    unconfirmedOnly: "No strong trend",
    confirmedStatus: "Strong trend",
    unconfirmedStatus: "No strong trend",
    noConfirmations: "No strong trend",
    confirmBuyTitle: "Strong trend signal received",
    ...
    confirmationStats: "Strong Trend Stats",
    confirmVsNoConfirm: "Strong Trend vs No Strong Trend",
...
Object.assign(translations.vi, {
  ...
  allocationWeight: "Tỷ trọng",
  portfolioPl: "Lãi/lỗ",
  confirm: "Xu hướng mạnh",
  confirmAll: "Tất cả trạng thái xu hướng",
  confirmedOnly: "Xu hướng mạnh",
  unconfirmedOnly: "Chưa có xu hướng mạnh",
  confirmedStatus: "Xu hướng mạnh",
  unconfirmedStatus: "Chưa có xu hướng mạnh",
  noConfirmations: "Chưa có xu hướng mạnh",
  confirmBuyTitle: "Đã có tín hiệu xu hướng mạnh",
  dailyPerformance: "Hiệu suất ngày",
  savedDailyPerformance: "Hiệu suất ngày đã lưu",
  date: "Ngày",
  equityValue: "Vốn",
  savedAt: "Lúc lưu",
  noDailyPerformance: "Chưa có hiệu suất ngày đã lưu",
  confirmationStats: "Thống kê xu hướng mạnh",
  confirmVsNoConfirm: "Có xu hướng mạnh vs chưa có",
  avgReturn: "Lãi/lỗ TB",
  totalReturn: "Tổng lãi/lỗ",
  exportBackup: "Xuất / Sao lưu",
  downloadData: "Tải dữ liệu",
