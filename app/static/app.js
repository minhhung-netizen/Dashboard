...
const translations = {
  en: {
    ...
    portfolioPl: "P/L",
    confirm: "Trend",
    confirmAll: "All strong signal states",
    confirmedOnly: "Strong signal",
    unconfirmedOnly: "No strong signal",
    confirmedStatus: "Strong signal",
    unconfirmedStatus: "No strong signal",
    noConfirmations: "No strong signal",
    confirmBuyTitle: "Strong signal received",
...
Object.assign(translations.vi, {
  ...
  portfolioPl: "Lãi/lỗ",
  confirm: "Xu hướng",
  confirmAll: "Tất cả trạng thái tín hiệu mạnh",
  confirmedOnly: "Có tín hiệu mạnh",
  unconfirmedOnly: "Chưa có tín hiệu mạnh",
  confirmedStatus: "Có tín hiệu mạnh",
  unconfirmedStatus: "Chưa có tín hiệu mạnh",
  noConfirmations: "Chưa có tín hiệu mạnh",
  confirmBuyTitle: "Đã có tín hiệu mạnh",
  dailyPerformance: "Hiệu suất ngày",
  savedDailyPerformance: "Hiệu suất ngày đã lưu",
  date: "Ngày",
  equityValue: "Vốn",
